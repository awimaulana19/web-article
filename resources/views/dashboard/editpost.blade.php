...
@section('content')
    <div class="col-lg-8">
        <form enctype="multipart/form-data" method="post" action="/mypost/{{ $posts->slug }}">
            @method('put')
            @csrf
            <div class="mb-3">
            ...
            <input type="hidden" name="gambarLama" value="{{ $posts->gambar }}">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                @enderror
                <input id="isi" type="hidden" name="isi" value="{{ old('isi', $posts->isi) }}">
